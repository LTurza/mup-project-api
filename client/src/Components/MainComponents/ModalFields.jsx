...
const ModalTextField = ({fieldValue, fieldName, label, userDataHandler}) => {
  return (
...
const ModalEmailField = ({fieldValue, fieldName, placeholder, label, userDataHandler}) => {
...
const ModalPasswordField = ({fieldValue, fieldName, label, userDataHandler}) => {
  return(
