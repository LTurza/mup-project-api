...
describe ('teamController', () => {
  ...
  describe ('Create new Team', () => {
    it('should response with status code 201 if team created succesfuly', (done) => {
  ...
  describe('Add user to team', () => {
    it('should response with status code 200 when successfuly add new team member', (done) => {
    ...
    it('should response with status code 400 if team or user dosn\' exisit', (done) => {
